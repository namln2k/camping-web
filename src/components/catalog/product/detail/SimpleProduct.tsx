...
export default function SimpleProduct({ product, className = '' }: Props) {
    const { name: productName, price_range, category, rating_summary, review_count, media_gallery_entries } = product
